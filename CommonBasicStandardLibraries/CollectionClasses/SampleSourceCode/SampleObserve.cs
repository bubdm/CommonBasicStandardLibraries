...
namespace CommonBasicStandardLibraries.CollectionClasses.SampleSourceCode
{
    internal class ObservableCollection<T> : CommonBasicStandardLibraries.CollectionClasses.SampleSourceCode.Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        //------------------------------------------------------
        //
        //  Constructors
