...
using SimpleJson.Serialization;
...
namespace SimpleJson
{
    public static class JsonConvert
    {
        ...
        //[CLSCompliant(false)] //risking this.
        ...
        /// <returns>A JSON string representation of the object.</returns>
        [DebuggerStepThrough]
        private static string SerializeObject(object value, params JsonConverter[] converters)
        {
        ...
        /// </returns>
        [DebuggerStepThrough]
        private static string SerializeObject(object value, Formatting formatting, JsonSerializerSettings settings)
        {
            return SerializeObject(value, null, formatting, settings);
        }

        [DebuggerStepThrough]
        private static string SerializeObject(object value, Type type, Formatting formatting, JsonSerializerSettings settings)
        {
        ...
        /// </returns>
        [DebuggerStepThrough]
        private static string SerializeObject(object value, Type type, JsonSerializerSettings settings)
        {
            JsonSerializer jsonSerializer = JsonSerializer.CreateDefault(settings);
