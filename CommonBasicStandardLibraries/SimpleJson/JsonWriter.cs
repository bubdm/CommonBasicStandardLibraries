...
namespace SimpleJson
{
    ...
    public abstract partial class JsonWriter : IDisposable
    {
        ...
        internal void WriteToken(JsonReader reader)
        {
        ...
        internal void WriteToken(JsonReader reader, bool writeChildren)
        {
        ...
        /// </param>
        internal void WriteToken(JsonToken token, object value)
        {
            switch (token)
            {
                case JsonToken.None:
        ...
        /// </summary>
        /// <param name="token">The <see cref="JsonToken"/> to write.</param>
        internal void WriteToken(JsonToken token)
        {
