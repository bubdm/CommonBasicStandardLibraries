...
namespace SimpleJson.Serialization
{
    ...
    internal class DefaultContractResolver : IContractResolver
    {
        ...
        private static readonly JsonConverter[] BuiltInConverters =
        {
            ...
            //taking a risk.  hopefully it pays off (?) since there was an obsolete tag.
        ...
        private MemberInfo GetExtensionDataMemberForType(Type type)
        {
            ...
            MemberInfo extensionDataMember = members.LastOrDefault(m =>
            {
                ...
                if (ReflectionUtils.ImplementsGenericDefinition(t, typeof(IDictionary<,>), out Type dictionaryType))
                {
                    ...
                    throw new JsonException("If Linq is required, needs more work");
