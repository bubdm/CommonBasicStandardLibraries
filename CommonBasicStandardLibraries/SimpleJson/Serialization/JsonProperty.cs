...
namespace SimpleJson.Serialization
{
    ...
    /// </summary>
    internal class JsonProperty //if i have to make public, can do so
    {
        ...
        internal IAttributeProvider AttributeProvider { get; set; }
        ...
        internal JsonConverter Converter { get; set; }
