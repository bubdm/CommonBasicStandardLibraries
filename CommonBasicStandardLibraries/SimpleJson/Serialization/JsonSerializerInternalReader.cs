...
namespace SimpleJson.Serialization
{
    internal class JsonSerializerInternalReader : JsonSerializerInternalBase
    {
        ...
        private object CreateValueInternal(JsonReader reader, Type objectType, JsonContract contract, JsonProperty member, JsonContainerContract containerContract, JsonProperty containerMember, object existingValue)
        {
            ...
            {
                throw new Exception("Rethink Linq");
            ...
            do
            {
                switch (reader.TokenType)
                {
                    ...
                    case JsonToken.Undefined:
                        ...
                        return EnsureType(reader, reader.Value, CultureInfo.InvariantCulture, contract, objectType);
                    case JsonToken.Raw:
                        throw new Exception("Needs To Rethink JRAW");
        ...
        private object CreateObject(JsonReader reader, Type objectType, JsonContract contract, JsonProperty member, JsonContainerContract containerContract, JsonProperty containerMember, object existingValue)
        {
            ...
            else if (Serializer.MetadataPropertyHandling == MetadataPropertyHandling.ReadAhead)
            {
                ...
                //    reader = tokenReader;
                //}
                throw new Exception("CreateObject On InternalReader Needs Rethinking.  Means needs linq afterall.");
            ...
            {
                throw new Exception("Needs linq for hasnodefinedtype");
        ...
        private object CreateList(JsonReader reader, Type objectType, JsonContract contract, JsonProperty member, object existingValue, string id)
        {
            ...
            if (HasNoDefinedType(contract))
            {
                throw new Exception("CreateList has no define.  Rethink");
                //return CreateJToken(reader, contract);
            }
        ...
        private object ReadExtensionDataValue(JsonObjectContract contract, JsonProperty member, JsonReader reader)
        {
            ...
            //{
            //    throw new Exception("ReadExtensionDatevalue needs rethinking.  Linq");
